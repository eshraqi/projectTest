...
class CityUpdateScreen extends StatefulWidget{
  const CityUpdateScreen({Key? key}) : super(key: key);
...
//------------------------------------------------
class CityUpdateState extends State<CityUpdateScreen>{
  late Cat cat;
            ...
            child: catList == null
                ...
                child: Stack(children: <Widget>[
                  Column(children: <Widget>[
                    // const Divider(color: AppColor.dividerLine),
                    const SizedBox(
                      height: 20,
                    ),
...
//-----------------------------------------------
  Future<bool> _updateDataSqlite(int index) async {
    var db = CatProvider();
    try {
      await db.open();
      await db.updateCat(fido);
      await db.close();
      return true;
    } catch (e) {
      return false;
